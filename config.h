...
#define FFMPEG_CONFIGURATION "--prefix=/usr/local --disable-everything --disable-gpl --disable-nonfree --disable-network --enable-pthreads --disable-shared --enable-static --disable-debug --disable-ffplay --disable-doc --enable-runtime-cpudetect --disable-network --disable-devices --disable-protocols --enable-protocol=file --enable-protocol=pipe --enable-protocol=tee --enable-swresample --enable-filter=aresample --enable-ffmpeg --enable-libfdk-aac --enable-libmp3lame --enable-libvorbis --enable-libopus --enable-parser='aac,mpegaudio,vorbis,opus' --enable-demuxer='mp3,aac,wav,asf,ogg' --enable-muxer=mp3 --enable-decoder='mp3,aac,pcm*,wma*,libvorbis,libopus' --enable-encoder=libmp3lame"
